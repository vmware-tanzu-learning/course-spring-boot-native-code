...
public class CashCardController {
    ...
    public String findAll(Model model) throws IOException {
        ...
        String banner = new String(FileCopyUtils.copyToByteArray(resource.getInputStream()), StandardCharsets.UTF_8);
        model.addAttribute("banner", banner);

        List<CashCardDto> cashcards = StreamSupport
                .stream(cashCardRepository.findAll().spliterator(), false)
